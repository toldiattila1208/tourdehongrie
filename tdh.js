...
function frissit() {
  ...
  var szemely = document.getElementById('szemely').value;
  
  var eredmenyek = gyoztesek[sorsz].split(";");
  var eredmeny = eredmenyek[szemely - 1];
  
  document.getElementById('eredmeny').innerHTML = listaelem(eredmeny);
}
